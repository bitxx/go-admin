...
<script>
import { getGenTable, updateGenTable } from '@/api/admin/sys/tools/table'
import { optionselect as getDictOptionselect } from '@/api/admin/sys/dicttype'
...
export default {
  ...
  beforeCreate() {
    ...
    if (tableId) {
      ...
      this.getDicts('admin_sys_gen_go_type').then(response => {
        this.sysGenGoTypeOptions = response.data
      })
      this.getDicts('admin_sys_gen_query_type').then(response => {
        this.sysGenQueryTypeOptions = response.data
      })
      this.getDicts('admin_sys_gen_html_type').then(response => {
