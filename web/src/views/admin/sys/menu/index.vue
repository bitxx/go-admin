      ...
      <el-card class="box-card">
        <el-form ref="queryForm" :model="queryParams" :inline="true" label-width="68px">
          ...
          <el-form-item>
            ...
            <el-button
              v-permisaction="['admin:sys-menu:add']"
              type="primary"
              icon="el-icon-plus"
              size="mini"
              @click="handleAdd"
        ...
        <el-table v-loading="loading" stripe border :data="menuList" row-key="id" :tree-props="{children: 'children', hasChildren: 'hasChildren'}">
          ...
          <el-table-column label="操作" fixed="right" align="center" class-name="small-padding fixed-width" width="180">
            <template slot-scope="scope">
              <el-button
                v-permisaction="['admin:sys-menu:edit']"
                size="mini"
                type="text"
                icon="el-icon-edit"
              ...
              >新增</el-button>
              <el-button
                v-permisaction="['admin:sys-menu:del']"
                size="mini"
                type="text"
                icon="el-icon-delete"
...
import {getListSysApi} from '@/api/admin/sys/api'
...
export default {
  ...
  created() {
    ...
    this.getDicts('admin_sys_menu_type').then(response => {
