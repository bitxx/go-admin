  ...
  <div class="login-container">
    ...
    <div class="login-weaper animated bounceInDown">
      <div class="login-left">
        ...
        <img :src="sysInfo.admin_sys_app_logo" alt="" class="img">
        <p class="title" v-text="sysInfo.admin_sys_app_name" />
      </div>
...
<script>
import { getCodeImg } from '@/api/admin/sys/user'
  ...
  methods: {
    getSystemSetting() {
      this.$store.dispatch('system/settingDetail').then((ret) => {
        this.sysInfo = ret
        document.title = ret.admin_sys_app_name
      })
    },
    getCurrentTime() {
