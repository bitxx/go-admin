    ...
    <template #wrapper>
      <el-card class="box-card">
        ...
        <el-row :gutter="10" class="mb8">
          <el-col :span="1.5">
            <el-button
              v-permisaction="['admin:sys-oper-log:export']"
              type="success"
              icon="el-icon-plus"
              size="mini"
              @click="handleExport"
        ...
        <el-table v-loading="loading" stripe border :data="list">
          ...
          <el-table-column label="操作" width="150" fixed="right" align="center" class-name="small-padding fixed-width">
            <template slot-scope="scope">
              <el-button
                v-permisaction="['admin:sys-oper-log:query']"
                size="mini"
                type="text"
                icon="el-icon-view"
...
<script>
import { listSysOperlog, delSysOperlog, exportSysOperlog } from '@/api/admin/sys/operlog'
