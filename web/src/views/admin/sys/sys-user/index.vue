        ...
        <el-row :gutter="20">
          ...
          <el-col :span="20" :xs="24">
            ...
            <el-row :gutter="10" class="mb8">
              <el-col :span="1.5">
                <el-button
                  v-permisaction="['admin:sys-user:add']"
                  type="primary"
                  icon="el-icon-plus"
                  size="mini"
                  @click="handleAdd"
            ...
            <el-table v-loading="loading" stripe border :data="userList">
              ...
              <el-table-column label="操作" width="160" fixed="right" class-name="small-padding fixed-width">
                <template slot-scope="scope">
                  <el-button
                    v-permisaction="['admin:sys-user:edit']"
                    size="mini"
                    type="text"
                    icon="el-icon-edit"
                  ...
                  <el-button
                    v-if="scope.row.id !== 1"
                    v-permisaction="['admin:sys-user:del']"
                    size="mini"
                    type="text"
                    icon="el-icon-delete"
                  ...
                  >删除</el-button>
                  <el-button
                    v-permisaction="['admin:sys-user:edit-pwd']"
                    size="mini"
                    type="text"
                    icon="el-icon-key"
...
<script>
import { listUser, getUser, delUser, addUser, updateUser, exportUser, resetUserPwd, changeUserStatus } from '@/api/admin/sys/user'
...
export default {
  ...
  created() {
    ...
    this.getDicts('admin_sys_user_sex').then(response => {
