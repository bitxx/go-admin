...
INSERT INTO `sys_menu` (`id`, `name`, `title`, `icon`, `path`, `element`, `redirect`, `permission`, `sort`, `parent_id`, `parent_ids`, `menu_type`, `is_keep_alive`, `is_affix`, `is_hidden`, `is_frame`, `create_by`, `update_by`, `created_at`, `updated_at`) VALUES (49, 'SysEditTable', '代码生成修改', 'AliwangwangOutlined', '/sys-tools/sys-editTable', '/sys/tools/gen/editTable', NULL, '', 100, 54, '0,54,', '2', '2', '2', '1', '1', 1, 1, '2020-04-11 15:52:48', '2023-05-09 11:14:37');
INSERT INTO `sys_menu` (`id`, `name`, `title`, `icon`, `path`, `element`, `redirect`, `permission`, `sort`, `parent_id`, `parent_ids`, `menu_type`, `is_keep_alive`, `is_affix`, `is_hidden`, `is_frame`, `create_by`, `update_by`, `created_at`, `updated_at`) VALUES (50, 'SysMonitor', '服务监控', 'ArrowLeftOutlined', '/sys-tools/sys-monitor', '/sys/tools/monitor/monitor', NULL, '', 0, 54, '0,54,', '2', '2', '2', '2', '1', 1, 1, '2020-04-14 00:28:19', '2023-05-09 10:52:46');
