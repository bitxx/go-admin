...
INSERT INTO `sys_api` (`id`, `handle`, `title`, `path`, `api_type`, `action`, `created_at`, `updated_at`, `create_by`, `update_by`) VALUES (29, 'go-admin/app/admin/apis.ServerMonitor.ServerInfo-fm', '系统-获取运行环境状态', '/admin-api/v1/server-monitor', '1', 'GET', '2023-05-08 16:51:19', '2024-12-11 11:03:23', 0, 1);
