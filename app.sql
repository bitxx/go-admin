...
INSERT INTO `sys_menu` (`id`, `name`, `title`, `icon`, `path`, `element`, `redirect`, `permission`, `sort`, `parent_id`, `parent_ids`, `menu_type`, `is_keep_alive`, `is_affix`, `is_hidden`, `is_frame`, `create_by`, `update_by`, `created_at`, `updated_at`) VALUES (7, 'SysMenu', '菜单管理', 'CheckOutlined', '/sys/sys-menu', '/sys/menu/index.vue', NULL, '', 30, 1, '0,1,', '2', '2', '2', '2', '1', 1, 1, '2021-05-20 22:08:45', '2023-04-27 16:32:41');
INSERT INTO `sys_menu` (`id`, `name`, `title`, `icon`, `path`, `element`, `redirect`, `permission`, `sort`, `parent_id`, `parent_ids`, `menu_type`, `is_keep_alive`, `is_affix`, `is_hidden`, `is_frame`, `create_by`, `update_by`, `created_at`, `updated_at`) VALUES (8, 'SysRole', '角色管理', 'BoxPlotFilled', '/sys/sys-role', '/sys/role/index.vue', NULL, '', 20, 1, '0,1,', '2', '2', '2', '2', '1', 1, 1, '2021-05-20 22:08:45', '2023-04-27 16:32:41');
INSERT INTO `sys_menu` (`id`, `name`, `title`, `icon`, `path`, `element`, `redirect`, `permission`, `sort`, `parent_id`, `parent_ids`, `menu_type`, `is_keep_alive`, `is_affix`, `is_hidden`, `is_frame`, `create_by`, `update_by`, `created_at`, `updated_at`) VALUES (9, 'SysDept', '部门管理', 'CheckCircleTwoTone', '/sys/sys-dept', '/sys/dept/index.vue', NULL, '', 40, 1, '0,1,', '2', '2', '2', '2', '1', 1, 1, '2021-05-20 22:08:45', '2023-04-27 16:32:41');
INSERT INTO `sys_menu` (`id`, `name`, `title`, `icon`, `path`, `element`, `redirect`, `permission`, `sort`, `parent_id`, `parent_ids`, `menu_type`, `is_keep_alive`, `is_affix`, `is_hidden`, `is_frame`, `create_by`, `update_by`, `created_at`, `updated_at`) VALUES (10, 'SysPost', '岗位管理', 'BorderRightOutlined', '/sys/sys-post', '/sys/post/index.vue', NULL, '', 50, 1, '0,1,', '2', '2', '2', '2', '1', 1, 1, '2021-05-20 22:08:45', '2023-04-27 16:32:41');
INSERT INTO `sys_menu` (`id`, `name`, `title`, `icon`, `path`, `element`, `redirect`, `permission`, `sort`, `parent_id`, `parent_ids`, `menu_type`, `is_keep_alive`, `is_affix`, `is_hidden`, `is_frame`, `create_by`, `update_by`, `created_at`, `updated_at`) VALUES (11, 'SysDicttype', '字典管理', 'ArrowUpOutlined', '/sys/sys-dicttype', '/sys/dicttype/index.vue', NULL, '', 60, 1, '0,1,', '2', '2', '2', '2', '1', 1, 1, '2021-05-20 22:08:45', '2023-04-27 16:32:41');
...
INSERT INTO `sys_menu` (`id`, `name`, `title`, `icon`, `path`, `element`, `redirect`, `permission`, `sort`, `parent_id`, `parent_ids`, `menu_type`, `is_keep_alive`, `is_affix`, `is_hidden`, `is_frame`, `create_by`, `update_by`, `created_at`, `updated_at`) VALUES (14, 'SysLoginlog', '登录日志', 'BlockOutlined', '/sys/sys-loginlog', '/sys/loginlog/index.vue', NULL, '', 90, 1, '0,1,', '2', '2', '2', '2', '1', 1, 1, '2021-05-20 22:08:45', '2023-04-27 16:32:41');
INSERT INTO `sys_menu` (`id`, `name`, `title`, `icon`, `path`, `element`, `redirect`, `permission`, `sort`, `parent_id`, `parent_ids`, `menu_type`, `is_keep_alive`, `is_affix`, `is_hidden`, `is_frame`, `create_by`, `update_by`, `created_at`, `updated_at`) VALUES (15, 'SysOperalog', '操作日志', 'CarFilled', '/sys/sys-operalog', '/sys/operlog/index.vue', NULL, '', 120, 1, '0,1,', '2', '2', '2', '2', '1', 1, 1, '2021-05-20 22:08:45', '2023-04-27 16:32:41');
...
INSERT INTO `sys_menu` (`id`, `name`, `title`, `icon`, `path`, `element`, `redirect`, `permission`, `sort`, `parent_id`, `parent_ids`, `menu_type`, `is_keep_alive`, `is_affix`, `is_hidden`, `is_frame`, `create_by`, `update_by`, `created_at`, `updated_at`) VALUES (48, 'SysGen', '代码生成', 'AndroidOutlined', '/sys-tools/sys-gen', '/sys/tools/gen/index.vue', NULL, '', 20, 54, '0,54,', '2', '2', '2', '2', '1', 1, 1, '2020-04-11 15:52:48', '2023-05-09 10:55:36');
INSERT INTO `sys_menu` (`id`, `name`, `title`, `icon`, `path`, `element`, `redirect`, `permission`, `sort`, `parent_id`, `parent_ids`, `menu_type`, `is_keep_alive`, `is_affix`, `is_hidden`, `is_frame`, `create_by`, `update_by`, `created_at`, `updated_at`) VALUES (49, 'SysEditTable', '代码生成修改', 'AliwangwangOutlined', '/sys-tools/sys-editTable', '/sys/tools/gen/editTable.vue', NULL, '', 100, 54, '0,54,', '2', '2', '2', '1', '1', 1, 1, '2020-04-11 15:52:48', '2023-05-09 11:14:37');
INSERT INTO `sys_menu` (`id`, `name`, `title`, `icon`, `path`, `element`, `redirect`, `permission`, `sort`, `parent_id`, `parent_ids`, `menu_type`, `is_keep_alive`, `is_affix`, `is_hidden`, `is_frame`, `create_by`, `update_by`, `created_at`, `updated_at`) VALUES (50, 'SysMonitor', '服务监控', 'ArrowLeftOutlined', '/sys-tools/sys-monitor', '/sys/tools/monitor/monitor.vue', NULL, '', 0, 54, '0,54,', '2', '2', '2', '2', '1', 1, 1, '2020-04-14 00:28:19', '2023-05-09 10:52:46');
...
INSERT INTO `sys_menu` (`id`, `name`, `title`, `icon`, `path`, `element`, `redirect`, `permission`, `sort`, `parent_id`, `parent_ids`, `menu_type`, `is_keep_alive`, `is_affix`, `is_hidden`, `is_frame`, `create_by`, `update_by`, `created_at`, `updated_at`) VALUES (70, 'UserConf', '用户配置', 'BorderRightOutlined', '/app/user/user-conf', '/app/user/user-conf/index.vue', NULL, '', 90, 59, '0,58,59,', '2', '2', '2', '2', '1', 1, 1, '2023-03-09 23:04:40', '2023-03-11 15:02:32');
...
INSERT INTO `sys_menu` (`id`, `name`, `title`, `icon`, `path`, `element`, `redirect`, `permission`, `sort`, `parent_id`, `parent_ids`, `menu_type`, `is_keep_alive`, `is_affix`, `is_hidden`, `is_frame`, `create_by`, `update_by`, `created_at`, `updated_at`) VALUES (73, 'User', '用户管理', 'BorderRightOutlined', '/app/user/user', '/app/user/user/index.vue', NULL, '', 30, 59, '0,58,59,', '2', '2', '2', '2', '1', 1, 1, '2023-03-09 23:18:49', '2023-05-08 16:19:31');
...
INSERT INTO `sys_menu` (`id`, `name`, `title`, `icon`, `path`, `element`, `redirect`, `permission`, `sort`, `parent_id`, `parent_ids`, `menu_type`, `is_keep_alive`, `is_affix`, `is_hidden`, `is_frame`, `create_by`, `update_by`, `created_at`, `updated_at`) VALUES (78, 'UserOperLog', '用户行为记录', 'BorderRightOutlined', '/app/user/user-oper-log', '/app/user/user-oper-log/index.vue', NULL, '', 120, 59, '0,58,59,', '2', '2', '2', '2', '1', 1, 1, '2023-03-11 15:00:06', '2023-03-11 15:02:42');
...
INSERT INTO `sys_menu` (`id`, `name`, `title`, `icon`, `path`, `element`, `redirect`, `permission`, `sort`, `parent_id`, `parent_ids`, `menu_type`, `is_keep_alive`, `is_affix`, `is_hidden`, `is_frame`, `create_by`, `update_by`, `created_at`, `updated_at`) VALUES (90, 'ContentCategory', '内容分类', 'BorderRightOutlined', '/plugins/content/content-category', '/plugins/content/content-category/index.vue', NULL, '', 0, 56, '0,57,56,', '2', '2', '2', '2', '1', 1, 1, '2023-03-12 23:17:44', '2023-03-12 23:20:35');
...
INSERT INTO `sys_menu` (`id`, `name`, `title`, `icon`, `path`, `element`, `redirect`, `permission`, `sort`, `parent_id`, `parent_ids`, `menu_type`, `is_keep_alive`, `is_affix`, `is_hidden`, `is_frame`, `create_by`, `update_by`, `created_at`, `updated_at`) VALUES (96, 'ContentArticle', '文章管理', 'BorderRightOutlined', '/plugins/content/content-article', '/plugins/content/content-article/index.vue', NULL, '', 60, 56, '0,57,56,', '2', '2', '2', '2', '1', 1, 1, '2023-03-12 23:52:45', '2023-03-12 23:53:12');
...
INSERT INTO `sys_menu` (`id`, `name`, `title`, `icon`, `path`, `element`, `redirect`, `permission`, `sort`, `parent_id`, `parent_ids`, `menu_type`, `is_keep_alive`, `is_affix`, `is_hidden`, `is_frame`, `create_by`, `update_by`, `created_at`, `updated_at`) VALUES (108, 'UserCountryCode', '国家区号', 'BorderRightOutlined', '/app/user/user-country-code', '/app/user/user-country-code/index.vue', NULL, '', 150, 59, '0,58,59,', '2', '2', '2', '2', '1', 1, 1, '2023-03-14 17:47:44', '2023-03-14 18:06:00');
