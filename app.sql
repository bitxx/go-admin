...
-- ----------------------------
BEGIN;
INSERT INTO `sys_menu` (`id`, `name`, `title`, `icon`, `path`, `element`, `redirect`, `permission`, `sort`, `parent_id`, `parent_ids`, `menu_type`, `is_keep_alive`, `is_affix`, `is_hidden`, `is_frame`, `create_by`, `update_by`, `created_at`, `updated_at`) VALUES (1, '', '系统管理', 'api-server', '/sys', 'Layout', '/sys/sys-api', '', 300, 0, '0,', '1', '', '', '2', '2', 1, 1, '2021-05-20 21:58:46', '2024-11-21 15:57:20');
INSERT INTO `sys_menu` (`id`, `name`, `title`, `icon`, `path`, `element`, `redirect`, `permission`, `sort`, `parent_id`, `parent_ids`, `menu_type`, `is_keep_alive`, `is_affix`, `is_hidden`, `is_frame`, `create_by`, `update_by`, `created_at`, `updated_at`) VALUES (2, 'SysUser', '用户管理', 'user', '/sys/sys-user', '/sys/user/index.vue', NULL, '', 10, 1, '0,2', '2', '2', '2', '2', '2', 1, 1, '2021-05-20 22:08:45', '2023-04-27 16:32:41');
...
INSERT INTO `sys_menu` (`id`, `name`, `title`, `icon`, `path`, `element`, `redirect`, `permission`, `sort`, `parent_id`, `parent_ids`, `menu_type`, `is_keep_alive`, `is_affix`, `is_hidden`, `is_frame`, `create_by`, `update_by`, `created_at`, `updated_at`) VALUES (7, 'SysMenu', '菜单管理', 'tree-table', '/sys/sys-menu', '/sys/menu/index.vue', NULL, '', 30, 1, '0,1,', '2', '2', '2', '2', '2', 1, 1, '2021-05-20 22:08:45', '2023-04-27 16:32:41');
INSERT INTO `sys_menu` (`id`, `name`, `title`, `icon`, `path`, `element`, `redirect`, `permission`, `sort`, `parent_id`, `parent_ids`, `menu_type`, `is_keep_alive`, `is_affix`, `is_hidden`, `is_frame`, `create_by`, `update_by`, `created_at`, `updated_at`) VALUES (8, 'SysRole', '角色管理', 'peoples', '/sys/sys-role', '/sys/role/index.vue', NULL, '', 20, 1, '0,1,', '2', '2', '2', '2', '2', 1, 1, '2021-05-20 22:08:45', '2023-04-27 16:32:41');
INSERT INTO `sys_menu` (`id`, `name`, `title`, `icon`, `path`, `element`, `redirect`, `permission`, `sort`, `parent_id`, `parent_ids`, `menu_type`, `is_keep_alive`, `is_affix`, `is_hidden`, `is_frame`, `create_by`, `update_by`, `created_at`, `updated_at`) VALUES (9, 'SysDept', '部门管理', 'tree', '/sys/sys-dept', '/sys/dept/index.vue', NULL, '', 40, 1, '0,1,', '2', '2', '2', '2', '2', 1, 1, '2021-05-20 22:08:45', '2023-04-27 16:32:41');
INSERT INTO `sys_menu` (`id`, `name`, `title`, `icon`, `path`, `element`, `redirect`, `permission`, `sort`, `parent_id`, `parent_ids`, `menu_type`, `is_keep_alive`, `is_affix`, `is_hidden`, `is_frame`, `create_by`, `update_by`, `created_at`, `updated_at`) VALUES (10, 'SysPost', '岗位管理', 'pass', '/sys/sys-post', '/sys/post/index.vue', NULL, '', 50, 1, '0,1,', '2', '2', '2', '2', '2', 1, 1, '2021-05-20 22:08:45', '2023-04-27 16:32:41');
INSERT INTO `sys_menu` (`id`, `name`, `title`, `icon`, `path`, `element`, `redirect`, `permission`, `sort`, `parent_id`, `parent_ids`, `menu_type`, `is_keep_alive`, `is_affix`, `is_hidden`, `is_frame`, `create_by`, `update_by`, `created_at`, `updated_at`) VALUES (11, 'SysDicttype', '字典管理', 'education', '/sys/sys-dicttype', '/sys/dicttype/index.vue', NULL, '', 60, 1, '0,1,', '2', '2', '2', '2', '2', 1, 1, '2021-05-20 22:08:45', '2023-04-27 16:32:41');
INSERT INTO `sys_menu` (`id`, `name`, `title`, `icon`, `path`, `element`, `redirect`, `permission`, `sort`, `parent_id`, `parent_ids`, `menu_type`, `is_keep_alive`, `is_affix`, `is_hidden`, `is_frame`, `create_by`, `update_by`, `created_at`, `updated_at`) VALUES (12, 'SysDictdata', '字典数据', 'education', '/sys/sys-dictdata', '/sys/dictdata/index.vue', NULL, '', 100, 1, '0,1,', '2', '2', '2', '1', '2', 1, 1, '2021-05-20 22:08:45', '2023-04-27 16:32:41');
INSERT INTO `sys_menu` (`id`, `name`, `title`, `icon`, `path`, `element`, `redirect`, `permission`, `sort`, `parent_id`, `parent_ids`, `menu_type`, `is_keep_alive`, `is_affix`, `is_hidden`, `is_frame`, `create_by`, `update_by`, `created_at`, `updated_at`) VALUES (13, 'SysConfig', '参数管理', 'swagger', '/sys/sys-config', '/sys/config/index.vue', NULL, '', 70, 1, '0,1,', '2', '2', '2', '2', '2', 1, 1, '2021-05-20 22:08:45', '2023-04-27 16:32:41');
INSERT INTO `sys_menu` (`id`, `name`, `title`, `icon`, `path`, `element`, `redirect`, `permission`, `sort`, `parent_id`, `parent_ids`, `menu_type`, `is_keep_alive`, `is_affix`, `is_hidden`, `is_frame`, `create_by`, `update_by`, `created_at`, `updated_at`) VALUES (14, 'SysLoginlog', '登录日志', 'logininfor', '/sys/sys-loginlog', '/sys/loginlog/index.vue', NULL, '', 90, 1, '0,1,', '2', '2', '2', '2', '2', 1, 1, '2021-05-20 22:08:45', '2023-04-27 16:32:41');
INSERT INTO `sys_menu` (`id`, `name`, `title`, `icon`, `path`, `element`, `redirect`, `permission`, `sort`, `parent_id`, `parent_ids`, `menu_type`, `is_keep_alive`, `is_affix`, `is_hidden`, `is_frame`, `create_by`, `update_by`, `created_at`, `updated_at`) VALUES (15, 'SysOperalog', '操作日志', 'skill', '/sys/sys-operalog', '/sys/operlog/index.vue', NULL, '', 120, 1, '0,1,', '2', '2', '2', '2', '2', 1, 1, '2021-05-20 22:08:45', '2023-04-27 16:32:41');
...
INSERT INTO `sys_menu` (`id`, `name`, `title`, `icon`, `path`, `element`, `redirect`, `permission`, `sort`, `parent_id`, `parent_ids`, `menu_type`, `is_keep_alive`, `is_affix`, `is_hidden`, `is_frame`, `create_by`, `update_by`, `created_at`, `updated_at`) VALUES (54, '', '系统工具', 'system-tools', '/sys-tools', 'Layout', '/sys-tools/sys-monitor', '', 330, 0, '0,', '1', '', '', '2', '2', 1, 1, '2021-05-21 11:13:32', '2024-11-21 15:57:40');
INSERT INTO `sys_menu` (`id`, `name`, `title`, `icon`, `path`, `element`, `redirect`, `permission`, `sort`, `parent_id`, `parent_ids`, `menu_type`, `is_keep_alive`, `is_affix`, `is_hidden`, `is_frame`, `create_by`, `update_by`, `created_at`, `updated_at`) VALUES (55, '', '文件管理', 'base-info', '/plugins/filemgr', '/index', '/plugins/filemgr/filemgr-app', '', 90, 57, '0,57,', '1', '', '', '2', '2', 1, 1, '2021-08-13 14:19:11', '2024-11-21 15:56:20');
INSERT INTO `sys_menu` (`id`, `name`, `title`, `icon`, `path`, `element`, `redirect`, `permission`, `sort`, `parent_id`, `parent_ids`, `menu_type`, `is_keep_alive`, `is_affix`, `is_hidden`, `is_frame`, `create_by`, `update_by`, `created_at`, `updated_at`) VALUES (56, '', '内容管理', 'clipboard', '/plugins/content', '/index', '/plugins/content/content-category', '', 60, 57, '0,57,', '1', '', '', '2', '2', 1, 1, '2021-08-16 18:01:20', '2024-11-21 15:55:48');
INSERT INTO `sys_menu` (`id`, `name`, `title`, `icon`, `path`, `element`, `redirect`, `permission`, `sort`, `parent_id`, `parent_ids`, `menu_type`, `is_keep_alive`, `is_affix`, `is_hidden`, `is_frame`, `create_by`, `update_by`, `created_at`, `updated_at`) VALUES (57, '', '插件管理', 'cascader', '/plugins', 'Layout', '/plugins/content/content-category', '', 270, 0, '0,', '1', '', '', '2', '2', 1, 1, '2023-03-07 10:37:37', '2024-11-21 15:55:39');
INSERT INTO `sys_menu` (`id`, `name`, `title`, `icon`, `path`, `element`, `redirect`, `permission`, `sort`, `parent_id`, `parent_ids`, `menu_type`, `is_keep_alive`, `is_affix`, `is_hidden`, `is_frame`, `create_by`, `update_by`, `created_at`, `updated_at`) VALUES (58, '', 'App应用', 'app-group-fill', '/app', 'Layout', '/app/user/user', '', 0, 0, '0,', '1', '', '', '2', '2', 1, 1, '2023-03-08 09:27:36', '2024-11-21 16:05:44');
INSERT INTO `sys_menu` (`id`, `name`, `title`, `icon`, `path`, `element`, `redirect`, `permission`, `sort`, `parent_id`, `parent_ids`, `menu_type`, `is_keep_alive`, `is_affix`, `is_hidden`, `is_frame`, `create_by`, `update_by`, `created_at`, `updated_at`) VALUES (59, '', '用户列表', 'chart', '/app/user', '/index', '/app/user/user', '', 30, 58, '0,58,', '1', '', '', '2', '2', 1, 1, '2023-03-09 14:24:25', '2024-11-21 15:53:06');
...
INSERT INTO `sys_menu` (`id`, `name`, `title`, `icon`, `path`, `element`, `redirect`, `permission`, `sort`, `parent_id`, `parent_ids`, `menu_type`, `is_keep_alive`, `is_affix`, `is_hidden`, `is_frame`, `create_by`, `update_by`, `created_at`, `updated_at`) VALUES (61, 'UserLevel', '用户等级', 'pass', '/app/user/user-level', '/app/user/user-level/index.vue', NULL, '', 60, 59, '0,58,59,', '2', '2', '2', '2', '2', 1, 1, '2023-03-09 21:33:49', '2023-03-09 23:05:34');
...
INSERT INTO `sys_menu` (`id`, `name`, `title`, `icon`, `path`, `element`, `redirect`, `permission`, `sort`, `parent_id`, `parent_ids`, `menu_type`, `is_keep_alive`, `is_affix`, `is_hidden`, `is_frame`, `create_by`, `update_by`, `created_at`, `updated_at`) VALUES (70, 'UserConf', '用户配置', 'pass', '/app/user/user-conf', '/app/user/user-conf/index.vue', NULL, '', 90, 59, '0,58,59,', '2', '2', '2', '2', '2', 1, 1, '2023-03-09 23:04:40', '2023-03-11 15:02:32');
...
INSERT INTO `sys_menu` (`id`, `name`, `title`, `icon`, `path`, `element`, `redirect`, `permission`, `sort`, `parent_id`, `parent_ids`, `menu_type`, `is_keep_alive`, `is_affix`, `is_hidden`, `is_frame`, `create_by`, `update_by`, `created_at`, `updated_at`) VALUES (73, 'User', '用户管理', 'pass', '/app/user/user', '/app/user/user/index.vue', NULL, '', 30, 59, '0,58,59,', '2', '2', '2', '2', '2', 1, 1, '2023-03-09 23:18:49', '2023-05-08 16:19:31');
...
INSERT INTO `sys_menu` (`id`, `name`, `title`, `icon`, `path`, `element`, `redirect`, `permission`, `sort`, `parent_id`, `parent_ids`, `menu_type`, `is_keep_alive`, `is_affix`, `is_hidden`, `is_frame`, `create_by`, `update_by`, `created_at`, `updated_at`) VALUES (78, 'UserOperLog', '用户行为记录', 'pass', '/app/user/user-oper-log', '/app/user/user-oper-log/index.vue', NULL, '', 120, 59, '0,58,59,', '2', '2', '2', '2', '2', 1, 1, '2023-03-11 15:00:06', '2023-03-11 15:02:42');
...
INSERT INTO `sys_menu` (`id`, `name`, `title`, `icon`, `path`, `element`, `redirect`, `permission`, `sort`, `parent_id`, `parent_ids`, `menu_type`, `is_keep_alive`, `is_affix`, `is_hidden`, `is_frame`, `create_by`, `update_by`, `created_at`, `updated_at`) VALUES (81, '', '消息管理', 'batch-update', '/plugins/msg', '/index', '/plugins/msg/msg-code', '', 120, 57, '0,57,', '1', '', '', '2', '2', 1, 1, '2023-03-12 13:27:59', '2024-11-21 15:56:39');
INSERT INTO `sys_menu` (`id`, `name`, `title`, `icon`, `path`, `element`, `redirect`, `permission`, `sort`, `parent_id`, `parent_ids`, `menu_type`, `is_keep_alive`, `is_affix`, `is_hidden`, `is_frame`, `create_by`, `update_by`, `created_at`, `updated_at`) VALUES (82, 'MsgCode', '验证码记录', 'pass', '/plugins/msg/msg-code', '/plugins/msg/msg-code/index.vue', NULL, '', 0, 81, '0,57,81,', '2', '2', '2', '2', '2', 1, 1, '2023-03-12 21:54:02', '2023-03-12 21:54:32');
...
INSERT INTO `sys_menu` (`id`, `name`, `title`, `icon`, `path`, `element`, `redirect`, `permission`, `sort`, `parent_id`, `parent_ids`, `menu_type`, `is_keep_alive`, `is_affix`, `is_hidden`, `is_frame`, `create_by`, `update_by`, `created_at`, `updated_at`) VALUES (108, 'UserCountryCode', '国家区号', 'pass', '/app/user/user-country-code', '/app/user/user-country-code/index.vue', NULL, '', 150, 59, '0,58,59,', '2', '2', '2', '2', '2', 1, 1, '2023-03-14 17:47:44', '2023-03-14 18:06:00');
