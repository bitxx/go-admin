...
INSERT INTO `sys_menu` (`id`, `name`, `title`, `icon`, `path`, `element`, `redirect`, `permission`, `sort`, `parent_id`, `parent_ids`, `menu_type`, `is_keep_alive`, `is_affix`, `is_hidden`, `is_frame`, `create_by`, `update_by`, `created_at`, `updated_at`) VALUES (119, 'Home', '首页', 'AlipayCircleFilled', '/home', '/sys/home/index', NULL, NULL, 0, 0, '0,', '2', '2', '1', '2', '1', 1, 1, '2024-11-22 11:34:20', '2024-11-22 11:34:20');
INSERT INTO `sys_menu` (`id`, `name`, `title`, `icon`, `path`, `element`, `redirect`, `permission`, `sort`, `parent_id`, `parent_ids`, `menu_type`, `is_keep_alive`, `is_affix`, `is_hidden`, `is_frame`, `create_by`, `update_by`, `created_at`, `updated_at`) VALUES (119, 'Home', '首页', 'AlipayCircleFilled', '/home', '/sys/home/index', NULL, NULL, 0, 0, '0,', '2', '2', '1', '2', '1', 1, 1, '2024-11-22 11:34:20', '2024-11-22 11:34:20');
COMMIT;
