...
INSERT INTO `sys_menu` (`id`, `title`, `icon`, `path`, `element`, `redirect`, `permission`, `sort`, `parent_id`, `parent_ids`, `menu_type`, `is_keep_alive`, `is_affix`, `is_hidden`, `is_frame`, `create_by`, `update_by`, `created_at`, `updated_at`) VALUES (73, '用户管理', 'BorderRightOutlined', '/app/user/user', '/app/user/user/index', NULL, '', 30, 59, '0,58,59,', '2', '2', '2', '2', '1', 1, 1, '2023-03-09 23:18:49', '2023-05-08 16:19:31');
