...
`关于前端技术我解释下`：  
因为我不太会前端，而且VUE3.0的Element-UI我感觉很难看，并且对VUE3.0也不怎么熟悉，因此就只能用vue2.0了，有兴趣的可以自行搞一套。  
...
在线体验：[go-admin入口](http://120.48.157.250:8001/)  
内置两个默认账户：  
账户：admin 密码：123456  顶级账户    
账户：test  密码：123456  菜单权限受限的账户  
`注：`该项目没有任何商业行为，只作为公开分享和交流，请友善体验，不要非法攻击该在线地址  
