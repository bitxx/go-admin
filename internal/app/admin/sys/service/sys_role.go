...
func (e *SysRole) Insert(c *dto.SysRoleInsertReq, cb *casbin.SyncedEnforcer) (int64, int, error) {
	...
	if c.RoleName == "" {
		return 0, clang.SysRoleNameEmptyCode, lang.MsgErr(clang.SysRoleNameEmptyCode, e.Lang)
	}
	if c.Status == "" {
		return 0, clang.SysRoleStatusEmptyCode, lang.MsgErr(clang.SysRoleStatusEmptyCode, e.Lang)
	}
	if c.RoleKey == "" {
		return 0, clang.SysRoleKeyEmptyCode, lang.MsgErr(clang.SysRoleKeyEmptyCode, e.Lang)
	}
	if c.RoleSort < 0 {
		return 0, clang.SysRoleSortEmptyCode, lang.MsgErr(clang.SysRoleSortEmptyCode, e.Lang)
	}
	...
	if count > 0 {
		return 0, clang.SysRoleKeyExistCode, lang.MsgErr(clang.SysRoleKeyExistCode, e.Lang)
	}
...
func (e *SysRole) Update(c *dto.SysRoleUpdateReq, cb *casbin.SyncedEnforcer) (bool, int, error) {
	...
	if respCode == clang.SuccessCode && role.Id != c.Id {
		return false, clang.SysRoleKeyExistCode, lang.MsgErr(clang.SysRoleKeyExistCode, e.Lang)
	}
	if role != nil && role.RoleKey == global.RoleKeyAdmin {
		return false, clang.SysRoleAdminNoOpCode, lang.MsgErr(clang.SysRoleAdminNoOpCode, e.Lang)
	}

	var data = models.SysRole{}
	err = e.Orm.Preload("SysMenu").First(&data, c.Id).Error
	if err != nil {
		return false, clang.DataQueryLogCode, lang.MsgLogErrf(e.Log, e.Lang, clang.DataQueryCode, clang.DataQueryLogCode, err)
	}
...
func (e *SysRole) Delete(ids []int64) (int, error) {
	...
	for _, id := range ids {
		...
		if err != nil {
			return clang.DataQueryLogCode, lang.MsgLogErrf(e.Log, e.Lang, clang.DataQueryCode, clang.DataQueryLogCode, err)
		}

		if role.RoleKey == global.RoleKeyAdmin {
			return clang.SysRoleAdminNoOpCode, lang.MsgErr(clang.SysRoleAdminNoOpCode, e.Lang)
		}
...
func (e *SysRole) GetMenuIdsByRole(roleId int64) ([]int64, int, error) {
	...
	return menuIds, clang.SuccessCode, nil
}
...
func (e *SysRole) GetDeptIdsByRole(roleId int64) ([]int64, int, error) {
	...
	return deptIds, clang.SuccessCode, nil
}
...
func (e *SysRole) GetWithName(d *dto.SysRoleQueryReq) (*models.SysRole, int, error) {
	...
	return model, clang.SuccessCode, nil
}
...
func (e *SysRole) GetPermissionsByRoleId(roleId int64) ([]string, int, error) {
	...
	return permissions, clang.SuccessCode, nil
}
